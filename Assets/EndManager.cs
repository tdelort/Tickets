    ...
    private void Start()
    {
        ...
        if (GameManager.propartiAlignment >= 0)
        {
            ...
            if (GameManager.migrantAlignment >= 0)
            {
                ...
                //si vous avez ignoré ou arrêté la résistante
                else if (GameManager.resistanteAlignment >= -1)
            ...
            else
            {
                ...
                //si vous avez ignoré ou arrêté la résistante
                    ...
                    endText.text ="Vous êtes le fleuron du pays. La crème de la crème. " +
        ...
        else
        {
            ...
            if (GameManager.migrantAlignment >= 0)
            {
                ...
                //si vous avez rejoins la resistante
                    ...
                    endText.text = "Vous embrassez totalement la vie de rebelle. Vous ne tardez pas à monter les échelons et " +
